 ...
 *
 * <p>This task delegates to {@link PolicyCompiler} from the {@code :policy} module.
 * If the source file does not exist, the task is skipped.
 */
public abstract class CompileJGuardPolicyTask extends DefaultTask {

    /**
     * The source policy descriptor file.
     * Task is skipped if this file does not exist.
     */
    @InputFile
    @SkipWhenEmpty
    ...
    public void compile() throws IOException {
        ...
        Path jsonPath = getIncludeJson().get() && getOutputJson().isPresent()
