 ...
 *
 * <ul>
 *   <li>{@link io.jguard.bootstrap.BootstrapEnforcer} - Main enforcement bridge
 *   <li>{@link io.jguard.bootstrap.AgentConfig} - Configuration from system properties
 *   <li>{@link io.jguard.bootstrap.EnforcementMode} - Enforcement mode (strict/permissive/audit)
 *   <li>{@link io.jguard.bootstrap.AgentLogger} - Simple console logger
 * </ul>
 */
