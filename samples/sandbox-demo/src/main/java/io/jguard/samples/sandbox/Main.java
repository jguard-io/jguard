 ...
 */
package io.jguard.samples.sandbox;
 ...
 *   <li>network.outbound - outbound network connections (from io.jguard.samples.sandbox.net
 *       package)
 *   <li>network.listen - server socket binding (from io.jguard.samples.sandbox.net package)
 *   <li>threads.create - thread creation (from io.jguard.samples.sandbox.worker package)
 *   <li>native.load - native library loading (from io.jguard.samples.sandbox.nativelib package)
 *   <li>env.read - environment variable access (from io.jguard.samples.sandbox.config package)
 ...
 *       io.jguard.samples.sandbox.config package)
 * </ul>
 *
