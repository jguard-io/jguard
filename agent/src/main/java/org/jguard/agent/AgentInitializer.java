 ...
 * org.jguard.bootstrap.* types are available from the bootstrap classloader.
 *
...
public final class AgentInitializer {
  ...
  private static void configureBootstrapEnforcer() {
    ...
    org.jguard.bootstrap.BootstrapEnforcer.setLogging(config.logDenied(), config.logAllowed());
